            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                ...
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li class="dropdown">
                            <a href="#">
                                <span>Bun venit, {{ $authUser->manager_name }}</span> <i
                                    class="bi bi-chevron-down toggle-dropdown"></i></a>
                            <ul>
                                <li>
                    ...
                    @foreach ($departments as $department)
                        <div class="col-xl-3 col-md-6">
                            <div class="icon-box">
                                ...
                                <h4 class="title"><a href="" class="stretched-link">{{ $department->name }}</a>
                                </h4>
                            </div>
                        </div><!--End Icon Box -->
                    @endforeach
              ...
              "breakpoints": {
                ...
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><img src="assets/img/clients/client-1.png"
                            src="{{ asset('images/clients/client-1.png') }}" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/img/clients/client-2.png"
                            src="{{ asset('images/clients/client-2.png') }}" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/img/clients/client-3.png"
                            src="{{ asset('images/clients/client-3.png') }}" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/img/clients/client-4.png"
                            src="{{ asset('images/clients/client-4.png') }}" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/img/clients/client-5.png"
                            src="{{ asset('images/clients/client-5.png') }}" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/img/clients/client-6.png"
                            src="{{ asset('images/clients/client-6.png') }}" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/img/clients/client-7.png"
                            src="{{ asset('images/clients/client-7.png') }}" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="assets/img/clients/client-8.png"
                            src="{{ asset('images/clients/client-8.png') }}" class="img-fluid" alt=""></div>
                </div>
            </div>
