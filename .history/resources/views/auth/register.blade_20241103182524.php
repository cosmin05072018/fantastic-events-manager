<style>
    ...
    select {
        background-color: #2d3748 !important; /* Fundal întunecat */
        color: #cbd5e0; /* Text deschis la culoare */
        border: 1px solid #4a5568; /* Bordură similară cu celelalte câmpuri */
        padding: 0.5rem;
        border-radius: 0.375rem; /* Rotunjirea colțurilor */
        height: 40px; /* Înălțime similară */
        width: 100%; /* Se extinde pe toată lățimea */
        appearance: none; /* Îndepărtează stilul implicit pentru browsere */
    }

    /* Săgeata din dreapta pentru select */
    select::-ms-expand {
        display: none; /* Ascunde săgeata în Internet Explorer */
    }

    /* Stil pentru placeholder */
    select option[value=""][disabled] {
        color: #a0aec0; /* Culoare mai pală pentru placeholder */
    }

    /* Hover și focus pentru select */
    select:hover, select:focus {
        border-color: #718096; /* Culoare pentru border la hover și focus */
        outline: none;
    }
</style>
