...
<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="company_name" :value="old('name')"
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="number" name="company_cui" :value="old('name')"
                required autofocus autocomplete="name" />
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
        </div>
        ...
        <!-- Nume Admin Firmă -->
        <div>
            <x-input-label class="mt-3" for="name" :value="__('Nume Manager')" />
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="manager_name" :value="old('name')"
                required autofocus autocomplete="name" />
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
        </div>
        ...
        <!-- Sediu Firmă -->
        <div>
            <x-input-label class="mt-3" for="name" :value="__('Sediu Firmă')" />
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="company_address" :value="old('name')"
                required autofocus autocomplete="name" />
            <x-input-error :messages="$errors->get('name')" class="mt-2" />
        </div>
