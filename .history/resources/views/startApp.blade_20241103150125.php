                ...
                <div class="card py-5 d-flex align-items-center justify-content-center hotel-manager">
                    <div class="card-body d-flex align-items-center flex-column justify-content-between">
                        ...
                        <button type="button" class="btns-first-page py-2 py-md-3 px-3 px-md-5">
                            <a class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" href="{{ route('login') }}">Să începem</a>
                        </button>
                    </div>
                </div>
            </div>
