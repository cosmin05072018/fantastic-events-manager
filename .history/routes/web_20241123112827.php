...
use App\Http\Controllers\SuperAdmin\AdminAuthenticatedSessionController;
...
Route::middleware(['auth:admin', 'checkRole:admin'])->group(function () {
    Route::get('/fantastic-admin/admin-section', [AdminSectionController::class, 'index'])->name('admin.section');
});

// Rute pentru writer
Route::middleware(['auth:admin', 'checkRole:writer'])->group(function () {
    Route::get('/fantastic-admin/writer-section', [WriterSectionController::class, 'index'])->name('writer.section');
});



// Route::get('/fantastic-admin', [FantasticAdminController::class, 'index'])->name('index');
