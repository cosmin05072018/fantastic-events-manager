...
Route::middleware('admin.access')->prefix('fantastic-admin')->name('admin.')->group(function () {
    ...
    // Route::put('/fantastic-admin/users-management/{user}/accept', [UserManagementController::class, 'accept'])->name('users.accept');

    // mail accepted
    Route::post('/users/{id}/accept', [UserManagementController::class, 'acceptUser'])->name('admin.users.accept');
