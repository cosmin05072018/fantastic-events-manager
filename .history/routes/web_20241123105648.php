...
Route::post('login-admin', [AdminAuthenticatedSessionController::class, 'store'])->name('login-admin.store');

// Rutele protejate pentru admini
Route::prefix('/fantastic-admin')->middleware(['auth:admin', 'checkRole:super_admin'])->group(function () {
    Route::get('', [FantasticAdminController::class, 'index'])->name('admin.dashboard');
});
